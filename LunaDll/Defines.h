...
DEFMEM(GM_WORLD_AUTOSTART_LVLNAME_PTR, VB6StrPtr,  0x00B25724);
DEFMEM(GM_WORLD_IS_HUB_EPISODE,        WORD,       0x00B25728);
DEFMEM(GM_WORLD_RESTART_LVL_ON_DEATH,  WORD,       0x00B2572A);
DEFMEM(GM_WORLD_TOTAL_STARS,           WORD,       0x00B2C906);
DEFMEM(GM_WORLD_CREDITS_ARRAY,         VB6StrPtr*, 0x00B2C8D8);
